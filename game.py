...
class Agent:
    ...
    def getAction(self, state):
        ...
        #possiby where answer to number 7 will go?
        print("in def getAction")
        raiseNotDefined()
    ...
    def run(self):
        ...
        while not self.gameOver:
            ...
            if self.catchExceptions:
                ...
                print("else of action")
                print("game 737 observation", observation)
                #action = Agent.getAction(self,observation)
                action = agent.getAction(observation)
                #action = 'East'
                print("action 736", action)
            self.unmute()
            ...
            if self.catchExceptions:
                ...
                print("747", agentIndex, action,self.state)
